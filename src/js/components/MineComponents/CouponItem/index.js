...
class CouponItem extends Component {
  ...
  render() {
    const {mode, coupon, checked, index} = this.props;
    ...
    return (
      <Swipeable className={`${styles.list}`}
        ...
        <div className={styles.couponlist} style={{transform: showDel ? 'translateX(-1.78rem)' : 'translateX(0)'}}>
          ...
          <div onClick={this.showDes.bind(this, coupon.id)} className={styles.couponbottom}>
            <div className={styles.coupondescription}>
              <p className={`${!openIntro ? 'text-overflow-1' :
